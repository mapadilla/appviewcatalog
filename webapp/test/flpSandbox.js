		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#appviewcatalog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appviewcatalog-display": {
								"semanticObject": "appviewcatalog",
								"action": "display",
								"description": "Aplicación con catálogo de vistas",
								"title": "App View Catalog",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appviewcatalog",
									"url": sap.ui.require.toUrl("appviewcatalog")
								}
							}
						}
					}
